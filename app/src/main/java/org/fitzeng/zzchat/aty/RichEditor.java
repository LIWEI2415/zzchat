...
import org.fitzeng.zzchat.util.BitMapUtil;
...
public class RichEditor extends WebView {
    ...
    public void setTextType(String type,int mode){
        String font="<link rel=\"stylesheet\" type=\"text/css\" href=\""+type+".css\">";
        if (mode == 1) {
            exec("javascript:RE.prepareInsert();");
            exec("javascript:RE.setTextType('" + font + "')");
        }else{
            exec("javascript:RE.changeTextType('" + font + "')");
        }
    }
    ...
    @Override public void setBackground(Drawable background) {
        Bitmap bitmap = BitMapUtil.toBitmap(background);
        String base64 = BitMapUtil.toBase64(bitmap);
        bitmap.recycle();
    ...
    public void insertTodo() {
        exec("javascript:RE.prepareInsert();");
        exec("javascript:RE.setTodo('" + BitMapUtil.getCurrentTime() + "');");
    }
