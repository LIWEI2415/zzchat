...
public class Utils {
    ...
    public static void saveFile(byte[] bfile, String filePath, String fileName) {
        ...
        try {
            ...
            if (!dir.exists()) {// 判断文件目录是否存在
                //如果文件目录不存在则创建目录
                dir.mkdirs();
                System.out.println("TAG:mkdirs"+dir.exists());
            }
    ...
    public static void copyAssetsFile2Phone(Activity activity, String fileName){
        try {
            ...
            File file = new File("file://"+activity.getFilesDir().getAbsolutePath() + File.separator + fileName);
     ...
     * @return
     */
    public static ArrayList<String> getFileName(String fileAbsolutePath, String type) {
